...
def get_answers(xml):
    ...
    try:
        for xml_cond in xml.findall(".//{http://www.imsglobal.org/xsd/ims_qtiasiv1p2}conditionvar"):
            ...
            if (
                xml_cond.find("{http://www.imsglobal.org/xsd/ims_qtiasiv1p2}vargte") is not None
                or xml_cond.find("{http://www.imsglobal.org/xsd/ims_qtiasiv1p2}varlte") is not None
            ):
